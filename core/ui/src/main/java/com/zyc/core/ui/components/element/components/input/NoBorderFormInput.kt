package com.zyc.core.ui.components.element.components.input
            ...
            decorationBox =
                @Composable { innerTextField ->
                    ...
                    TextFieldDefaults.DecorationBox(
                        ...
                        // 通常用于提供关于预期输入的提示
                        placeholder = { Text(modifier= Modifier.padding(start =  if (isFocused) 2.dp else 0.dp), text = placeholder, style = TextStyle(fontSize = 14.sp)) },
