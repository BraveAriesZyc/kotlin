...
class NavigationManager(private val navController: NavHostController) {
    ...
    fun navigateToMessage() {
        navigateTo(Routes.Message.Message)
    }
    ...
    fun navigateToSendMessage(conversationId: String) {
        navigateTo(Routes.Message.SendMessage(conversationId))
    }
    ...
    fun navigateToFriend() {
        navigateTo(Routes.Friend.Friend)
    }
    ...
    fun navigateToAddFriend() {
        navigateTo(Routes.Friend.AddFriend)
    }
    ...
    fun navigateToSetting() {
        navigateTo(Routes.Profile.Setting)
    }
    ...
    fun navigateToUIShowcase() {
        navigateTo(Routes.UIShowcase.UIShowcase)
    }
    ...
    fun navigateToWebView(url: String) {
        navigateTo(Routes.Common.WebView(url))
    }
